<template>
    <button class="post-btn">
        <span>CV</span>
        <svg xmlns="http://www.w3.org/2000/svg" view-box="0 0 66 43">
            <polygon
            points="39.58,4.46 44.11,0 66,21.5 44.11,43 39.58,38.54 56.94,21.5"></polygon>
...
.post-btn {
  --main-size: 3em;
  --color-text: #ffffff;
  --color-background: rgb(142, 112, 231);
  --color-background-hover: rgb(128, 96, 221);
...
.post-btn svg polygon:nth-child(1) {
  transition: 0.4s;
  transform: translateX(-60%);
}

.post-btn svg polygon:nth-child(2) {
  transition: 0.5s;
  transform: translateX(-30%);
}

.post-btn:hover svg polygon:nth-child(1) {
  transform: translateX(0%);
  animation: opacity 1s infinite 0.6s;
}

.post-btn:hover svg polygon:nth-child(2) {
  transform: translateX(0%);
  animation: opacity 1s infinite 0.4s;
}

.post-btn:hover svg polygon:nth-child(3) {
